...
FaceClusterImp::FaceClusterImp(float thresh)
{
    thresh_ = thresh;
    labels_num_ = 0;
    preds_num_ = 0;
...
std::pair<unsigned long, std::vector<unsigned long>> FaceClusterImp::_cluster(std::vector<std::vector<float>>& descriptors, float thresh)
{
...
std::pair<unsigned long, std::vector<unsigned long>> FaceClusterImp::Cluster(std::vector<std::vector<float> > & descriptors)
{
...
std::vector<float> FaceClusterImp::Metric(void)
{
